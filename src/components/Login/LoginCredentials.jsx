...
function LoginCredentials() {
  return (
    <div className='flex h-full lg:w-auto sm:w-3/4 lg:pl-8 sm:pl-0 mobile:items-center mobile:p-8 sm:items-center flex-col'>
        ...
        <div className='w-full mt-12'>
            <h1 className='text-white text-6xl font-bold mobile:text-4xl'>Happening now</h1>
        </div>
        <div className='mt-12 mobile:mt-8'>
            <h2 className='text-white text-3xl font-bold mobile:text-xl'>Join Twitter today.</h2>
        </div>
        <div className='w-full mt-8 mobile:mt-4 flex flex-col'>
