  ...
  return (
    <div className='hidden lg:w-auto lg:h-auto lg:flex lg:flex-col lg:pl-6 lg:mr-10 lg:mb-28'>
      <div className='h-12 flex fixed items-center bg-black top-0'>
        <input type="text" className='h-10 pl-12 mt-1 rounded-full bg-twitterbggray xl:w-80 lg:w-60 w-auto text-twitterwhite outline-none border-1 text-sm focus:outline-twitterblue focus:border-0' onClick={() => setInputState(true)} placeholder="Search Twitter" />
      ...
      <div className='flex flex-col h-72'>
        <div className='xl:w-80 lg:w-60 w-auto h-auto flex flex-col mt-14 bg-twitterbggray rounded-t-xl justify-between'>
