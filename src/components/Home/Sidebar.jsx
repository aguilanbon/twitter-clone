...
function Sidebar() {
  ...
  return (
    <div className='w-auto h-auto flex flex-col pl-6 mr-10 mb-28'>
      <div className='h-12 flex fixed items-center bg-black top-0'>
        <input type="text" className='h-8 pl-10 py-1 rounded-full bg-twitterbggray w-72 text-twitterwhite outline-none border-1 text-xs focus:outline-twitterblue focus:border-0' onClick={() => setInputState(true)} onout />
      ...
      <div className='flex flex-col h-72'>
        <div className='w-72 h-auto flex flex-col mt-14 bg-twitterbggray rounded-t-xl justify-between'>
