...
function Links() {
return (
<div className=' h-screen mt-2 flex flex-col w-full'>
    <svg viewBox="0 0 24 24" aria-hidden="true"
        className="w-7 fill-twitterwhite mb-4 r-jwli3a r-4qtqp9 r-yyyyoo r-rxcuwo r-1777fci r-m327ed r-dnmrzs r-494qqr r-bnwqim r-1plcrui r-lrvibr">
        <g>
            <path
    ...
    <li className='flex flex-col text-lg'>
        <a href="/" className='my-2 flex'><svg viewBox="0 0 24 24" aria-hidden="true"
                class="fill-twitterwhite w-5 mr-4 r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e">
                <g>
                    <path
