  ...
  return (
     <div className='w-full text-white flex items-center justify-between'>
        <div className='flex mr-2'>
          ...
          <div className='hover:bg-twitterblue hover:bg-opacity-10 p-2 rounded-full my-2 cursor-pointer hidden md:flex'>
          ...
          <div className='opacity-50 p-2 rounded-full my-2 cursor-pointer'>
        ...
        <div className='flex'>
            <button className='bg-twitterblue opacity-50 text-xs font-semibold py-2 px-4  rounded-full '>Tweet</button>
        </div>
    </div>
  )
}
