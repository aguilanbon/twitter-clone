          ...
          <div className='w-full h-auto flex bg-black hover:bg-twitterbggray hover:bg-opacity-90 text-sm '>
              ...
              <div className='py-4 flex flex-col'>
                <div className='flex flex-row w-full'>
                  <h2 className='pr-1 text-slate-300 overflow-hidden overflow-ellipsis whitespace-nowrap w-24'>Black Pantherssssssssssssss</h2>
                  <h2 className='pr-2 text-twittergray overflow-hidden overflow-ellipsis whitespace-nowrap w-24'>@BlackPantasssss</h2>
                  <div className='pr-2 flex items-center justify-center'>
                    <div className='w-1 h-1 rounded-full bg-twittergray flex '>
                    </div>
                  </div>
                  <h2 className='text-twittergray'>Jul 24, 2022</h2>
                </div>
