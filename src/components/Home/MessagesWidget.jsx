...
function MessagesWidget() {
  ...
  return (
    <div className={`fixed bg-black xl:w-96 w-80 ${isExpanded ? `h-3/5` : `h-12 items-center`}  bottom-0 right-5 pt-2 rounded-t-2xl shadow-twitter shadow-white hidden lg:flex cursor-pointer flex-col  transition-all duration-300`} onClick={() => setIsExpanded(prev => !prev)}>
