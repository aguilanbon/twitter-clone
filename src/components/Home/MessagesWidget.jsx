...
function MessagesWidget() {
  ...
  return (
    <div className={`fixed bg-black lg:w-96 w-64 ${isExpanded ? `h-96` : `h-12`}  bottom-0 right-5 px-3 rounded-t-lg shadow-twitter shadow-white flex items-center cursor-pointer justify-between transition-all`} onClick={() => setIsExpanded(prev => !prev)}>
