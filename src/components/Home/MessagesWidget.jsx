...
function MessagesWidget() {
  return (
    <div className='fixed bg-black w-80 h-12 bottom-0 right-5 px-3 rounded-t-lg shadow-twitter shadow-white flex items-center cursor-pointer justify-between'>
