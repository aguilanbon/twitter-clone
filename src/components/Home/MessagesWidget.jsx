...
function MessagesWidget() {
  ...
  return (
    <div className={`fixed bg-black lg:w-96 w-64 ${isExpanded ? `h-3/5` : `h-12 items-center`}  bottom-0 right-5 pt-2 rounded-t-2xl shadow-twitter shadow-white flex cursor-pointer flex-col  transition-all`} onClick={() => setIsExpanded(prev => !prev)}>
        ...
        <div className='flex w-full mt-1'>
          <div className='w-full h-16 flex bg-black hover:bg-twitterbggray hover:bg-opacity-90'>
