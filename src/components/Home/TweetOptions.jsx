  ...
  return (
    <div className='flex items-center justify-between w-10/12 ml-3 mt-3 text-xs'>
      <span className='flex text-twittergray items-center'>
        <div className='p-1 rounded-full hover:bg-twitterblue hover:bg-opacity-30 hover:text-twitterblue hover:fill-blue-600' onMouseEnter={() => setIsComments(true)} onMouseLeave={() => setIsComments(false)}>
