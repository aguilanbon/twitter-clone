  ...
  return (
    <div className='flex items-center justify-between w-10/12 ml-3 mt-3 text-xs'>
      <span className='flex text-twittergray items-center'>
        <div className='p-1 rounded-full hover:bg-twitterblue hover:bg-opacity-30 hover:text-twitterblue' onMouseEnter={() => setIsComments(true)} onMouseLeave={() => setIsComments(false)}>
      ...
      <span className='flex text-twittergray items-center'>
        <div className='p-1 rounded-full hover:bg-green-400 hover:bg-opacity-10 hover:text-green-400' onMouseEnter={() => setIsRetweet(true)} onMouseLeave={() => setIsRetweet(false)}>
      ...
      <span className='flex text-twittergray items-center'>
        <div className='p-1 rounded-full hover:bg-pink-400 hover:bg-opacity-10' onMouseEnter={() => setIsLike(true)} onMouseLeave={() => setIsLike(false)}>
