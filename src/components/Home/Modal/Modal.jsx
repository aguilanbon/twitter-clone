      ...
      <div className='flex flex-col'>
        ...
        <div className='w-full flex justify-between items-center p-3'>
          <div className='flex flex-row items-center'>
            <div className='flex items-center p-1 hover:bg-twittergray hover:bg-opacity-30 rounded-full cursor-pointer' onClick={() => setModalIsOpen(false)}>
        ...
        <div className='w-full border-b border-twitterhvgray flex items-center flex-row px-4'>
          <div>
