        ...
        <div className='flex w-full h-auto'>
            ...
            <div className='flex flex-col justify-start items-start w-full ml-2'>
                ...
                <div className='w-full text-white flex items-center justify-between my-2'>
                    ...
                    <div className='flex'>
                        <button className='bg-twitterblue text-xs font-semibold py-2 px-4  rounded-full '>Tweet</button>
                    </div>
                </div>
            </div>
        </div>
