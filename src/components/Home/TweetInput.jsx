        ...
        <div className='flex w-full h-auto'>
            ...
            <div className='flex flex-col justify-start items-start w-full ml-2'>
                <div className='w-full border-b border-twitterborder'>
                    <textarea name="" id="" cols="30" rows="1" className='w-full min-h-10 mt-2 overflow-hidden resize-none pl-2 bg-black focus:outline-0 text-twitterwhite' placeholder="What's Happening?"></textarea>
                    <button className='text-twitterblue text-xs mt-2 mb-2 pb-1 px-2 font-semibold flex items-center'>
